    ...
    return (
        <>
            ...
            <div className="container mt-4">
                {/* First Shelf */}
                <div className="row mb-4 d-flex justify-content-center shelf-color">
                    <div className="col-2 d-flex justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-1-circle" viewBox="0 0 16 16">
